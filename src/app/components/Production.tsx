            ...
            <div className="production-items">
              ...
              <Btn>
                <ProductionItem
                  ...
                  position="fourth"
                  language={language}
                  h3ES="Concept Art y Storyboarding"
                  h3EN="Concept Art and Storyboarding"
                  pES="Visualización rápida de ideas antes de rodar. Reducimos la incertidumbre creativa. Antes de encender una cámara, creamos concept art y storyboards hiperrealistas mediante IA para que visualices la estética final de tu proyecto."
                  pEN="Quickly visualize ideas before filming. We reduce creative uncertainty. Before a camera is even turned on, we create hyper-realistic concept art and storyboards using AI so you can visualize the final aesthetic of your project."
                />
              </Btn>
              <Btn>
                <ProductionItem
                  ...
                  position="fifth"
                  language={language}
                  h3ES="Inteligencia Artificial"
                  h3EN="Artificial Intelligence"
                  pES="De la idea al video final, en conjunto con el cliente creamos la idea, el story board, a la animación de piezas y el montaje final de audio y video integrados, reduciendo costos y obteniendo resultados cinematográficos de alta calidad."
                  pEN="From the initial idea to the final video, together with the client we created the concept, the storyboard, the animation of the pieces, and the final assembly of integrated audio and video, reducing costs and obtaining high-quality cinematic results."
                />
              </Btn>
              <Btn>
                <ProductionItem
                  ...
                  position="fifth"
                  language={language}
                  h3ES="Contenido Híbrido"
                  h3EN="Hybrid Content"
                  pES="Mezcla de material de archivo con secuencias generadas por IA para ilustrar conceptos abstractos o históricos."
                  pEN="A mix of archival footage and AI-generated sequences to illustrate abstract or historical concepts."
                />
              </Btn>
            </div>
          </div>
